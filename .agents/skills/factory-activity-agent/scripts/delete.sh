...
# Wrapper for factory_activity_agent.py delete
# Usage: delete.sh <activity> [--dry-run]
...
echo "==> Deleting activity $ACTIVITY"
echo ""

# shellcheck disable=SC2086
python3 "$AGENT_SCRIPT" delete "$ACTIVITY" $DRY_RUN

echo ""
echo "==> Delete complete for $ACTIVITY"
