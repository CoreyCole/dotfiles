...
Use this as the Outline stage for milestone-level QRSPI. It converts approved milestone design into a reviewed ticket-shaping outline and architecture-spec input artifact.
...
Every proposed ticket must map to at least one concise user story and one gap/dependency/taxonomy reason. Engineer-as-user stories are valid.
...
Keep concise. Sacrifice grammar for concision. Link canonical docs; do not copy full requirements.
