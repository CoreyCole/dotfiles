...
<qrspi-result>
  ...
  <next>
    <step>Read ~/.agents/skills/qrspi-planning/SKILL.md.</step>
    <step>Read ~/.agents/skills/q-design/SKILL.md.</step>
    <step>Read thoughts/.../research/YYYY-MM-DD_HH-MM-SS_topic-name.md.</step>
    <step>Start /q-design immediately unless blocked by an explicit human/safety gate.</step>
  </next>
</qrspi-result>
```
