...
- **`/research-codebase`**: Provides detailed technical findings and current state analysis
- **`/create-plan`**: Provides implementation approach, phases, and success criteria
