...
description: Applies q-review-plan findings after follow-up research. Use after q-research-for-review answers planning-review questions to update parent design.md, outline.md, and plan.md based on review.md plus the research doc.
---
...
```text
I'll apply planning review follow-up research to the parent design/outline/plan docs.
...
1. For each researched finding:
   ...
   - Edit the parent `design.md`, `outline.md`, and/or `plan.md` directly when the right planning-doc fix is now clear.
   - Preserve stage boundaries: design captures what and why, outline captures structure and slices, plan captures exact implementation steps.
...
Changes: [short summary of edits to design.md / outline.md / plan.md / AGENTS.md.]
...
- Keep stage boundaries clear between design, outline, and plan.
