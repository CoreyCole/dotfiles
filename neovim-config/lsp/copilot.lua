...
return {
    ...
    on_attach = function(client, bufnr)
        ...
        --     vim.lsp.inline_completion.enable(true, { bufnr = bufnr })
        --
        --     -- Set up keymaps for inline completion
        --     vim.keymap.set(
        --         "i",
        --         "<C-l>",
        --         vim.lsp.inline_completion.get,
        --         { desc = "Accept Copilot suggestion", buffer = bufnr }
        --     )
        --
        --     -- Accept only the next word
        --     vim.keymap.set("i", "<C-'>", function()
        --         vim.lsp.inline_completion. { kind = "word" }
        --     end, { desc = "Accept Copilot word", buffer = bufnr })
        --
        --     -- Accept only the current line
        --     vim.keymap.set("i", "<C-;>", function()
        --         vim.lsp.inline_completion.accept { kind = "line" }
        --     end, { desc = "Accept Copilot line", buffer = bufnr })
        --
        --     vim.keymap.set(
        --         "i",
        --         "<M-]>",
        --         vim.lsp.inline_completion.select,
        --         { desc = "Cycle Copilot suggestions", buffer = bufnr }
        --     )
        -- end

        -- User commands for sign in/out
