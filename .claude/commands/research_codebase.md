...
1. **Add GitHub permalinks (if applicable):**
   ...
   - Check if on develop branch or if commit is pushed: `git branch --show-current` and `git status`
   - If on develop, generate GitHub permalinks:
     - Get repo info: `gh repo view --json owner,name`
     - Create permalinks: `https://github.com/premiumlabs/monorepo/blob/{commit}/{file}#L{line}`
