...
def generate_status_line(input_data):
    """Generate the status line with context utilization, git branch, and most recent prompt."""
    ...
    if prompts:
        ...
        truncated = truncate_prompt(current_prompt, 400)
