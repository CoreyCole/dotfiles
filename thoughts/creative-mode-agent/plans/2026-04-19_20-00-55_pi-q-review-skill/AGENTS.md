...
- Draft a new QRSPI `/q-review` skill that sits after implement via handoff, produces a durable review artifact under `reviews/`, and does not edit code.

## Decisions to preserve

- `q-review` should combine plan validation and code review in one stage.
- `q-review` should stop at a review report for the engineer; it should not auto-fix code.
- The report should include severity-tagged findings plus suggested ways to address them.
- Fast verification only in `q-review` (build/lint/test-class commands as appropriate); broader manual/integration testing is deferred to a later `q-test` stage.
- Important review concerns include test meaningfulness, reducing unnecessary mocking, robust error handling, and adherence to codebase best practices.

## Canonical artifacts

- `prds/2026-04-19_20-59-56_q-review-skill-brief.md`
- `context/question/2026-04-19_20-59-56_q-review-scout.md`
