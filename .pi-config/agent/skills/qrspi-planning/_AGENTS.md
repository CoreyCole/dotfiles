---
source: ~/.pi/agent/skills/qrspi-planning/_AGENTS.md
copied_by: /skill:q-question
...
1. Read the pipeline overview with `/skill:qrspi-planning`.
...
|----------|-------|-------|------|
| `questions/*.md` | Question | `/skill:q-question` | Human |
| `research/*.md` | Research | `/skill:q-research` | Human |
| `design.md` | Design | `/skill:q-design` | Human |
| `outline.md` | Outline | `/skill:q-outline` | LLM review via `/skill:q-review [outline.md]` |
| `plan.md` | Plan | `/skill:q-plan` | LLM review via `/skill:q-review [plan.md]` |
| code changes | Implement | `/skill:q-implement` | LLM code review via `/skill:q-review [handoff.md]` |
| `reviews/*/review.md` | Review | `/skill:q-review` | Routes to planning or implementation review |
...
- `/skill:q-review [outline.md]` reviews `design.md`, optional `design-product.md`, and `outline.md`.
- `/skill:q-review [plan.md]` reviews `design.md`, optional `design-product.md`, `outline.md`, and `plan.md`.
...
- Resume stage work with `/skill:q-resume`.
- Create handoffs with `/skill:q-handoff`.
- During implementation, continue with `/skill:q-resume [handoff]` until the final completion handoff points to `/skill:q-review [handoff]`.
